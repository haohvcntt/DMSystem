...
import {
  ...
  transition,
  trigger
} from "./chunk-3OZWTCTO.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ScrollingModule,
  ViewportRuler
} from "./chunk-WU5J5SWE.js";
import "./chunk-EMBFMKVM.js";
import {
  BidiModule,
  DOWN_ARROW,
  Directionality,
...
var MatMenuItem = class _MatMenuItem {
  constructor(_elementRef, _document, _focusMonitor, _parentMenu, _changeDetectorRef) {
    ...
    this._hovered = new import_rxjs2.Subject();
    this._focused = new import_rxjs2.Subject();
...
var MatMenuContent = class _MatMenuContent {
  constructor(_template, _componentFactoryResolver, _appRef, _injector, _viewContainerRef, _document, _changeDetectorRef) {
    ...
    this._document = _document;
    this._changeDetectorRef = _changeDetectorRef;
    this._attached = new import_rxjs2.Subject();
  }
  /**
...
var MatMenuTrigger = class _MatMenuTrigger {
  ...
  constructor(_overlay, _element, _viewContainerRef, scrollStrategy, parentMenu, _menuItemInstance, _dir, _focusMonitor, _ngZone) {
    ...
    this._closingActionsSubscription = import_rxjs2.Subscription.EMPTY;
    this._hoverSubscription = import_rxjs2.Subscription.EMPTY;
    this._menuCloseSubscription = import_rxjs2.Subscription.EMPTY;
    ...
    if (menu instanceof MatMenu) {
      ...
      if (menu.lazyContent) {
        menu._animationDone.pipe(
          (0, import_operators2.filter)((event) => event.toState === "void"),
          (0, import_operators2.take)(1),
          // Interrupt if the content got re-attached.
          (0, import_operators2.takeUntil)(menu.lazyContent._attached)
        ).subscribe({
  ...
  _menuClosingActions() {
    ...
    const hover = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0, import_operators2.filter)((active) => active !== this._menuItemInstance), (0, import_operators2.filter)(() => this._menuOpen)) : (0, import_rxjs2.of)();
  ...
  _handleHover() {
    ...
    this._hoverSubscription = this._parentMaterialMenu._hovered().pipe((0, import_operators2.filter)((active) => active === this._menuItemInstance && !active.disabled), (0, import_operators2.delay)(0, import_rxjs2.asapScheduler)).subscribe(() => {
      this._openedBy = "mouse";
      if (this.menu instanceof MatMenu && this.menu._isAnimating) {
        this.menu._animationDone.pipe((0, import_operators2.take)(1), (0, import_operators2.delay)(0, import_rxjs2.asapScheduler), (0, import_operators2.takeUntil)(this._parentMaterialMenu._hovered())).subscribe(() => this.openMenu());
      } else {
        this.openMenu();
      }
    });
